...
<body id="body" class="desktop menu-mobile">
    ...
    <div class="container-fluid">
        ...
        <main class="page">
            <h3>Gemeinderat</h3>    
            <p>Der Gemeinderat für die aktuelle Legislaturperiode setzt sich wie folgt zusammen:</p>
            <div class="daten">
                <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/img/chart.svg"/>            
            </div>
        </main>
    </div>
